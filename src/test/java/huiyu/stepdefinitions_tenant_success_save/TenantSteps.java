package huiyu.stepdefinitions_tenant_success_save;
...
public class TenantSteps extends BaseTest {
    ...
    public void clickNewTenant() {
      ...
      WebElement new_tenant_btn = wait.until(
        ExpectedConditions.elementToBeClickable(
          By.cssSelector("#btn-new-tenant")
        )
      );
      new_tenant_btn.click();
    }//#btn-new-tenant
    ...
    //             By.cssSelector("groupui-table-cell"), name
    //         ));
